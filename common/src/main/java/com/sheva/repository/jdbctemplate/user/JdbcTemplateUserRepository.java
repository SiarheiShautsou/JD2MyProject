...
public class JdbcTemplateUserRepository implements UserRepositoryInterface {
    ...
    public User create(User object) {
        ...
        final String insertQuery = "insert into training_place.users (user_name, user_surname, birth, country, city, is_deleted, creation_date, modification_date, user_latitude, user_longitude) " +
    ...
    public User update(User object, Long id) {
        ...
        final String updateQuery = "update training_place.users set user_name = :user_name, user_surname = :user_surname, " +
                ...
                "user_latitude = :user_latitude, user_longitude = :user_longitude where id = " + id;
